...
public class QuestionBankController {
    ...
    public String createPaper(String candidate, String number) {
        ...
        return print(candidate,number,choiceQuestionList,answerQuestionList);

    }



    private String print(String candidate,String number,List<ChoiceQuestion> choiceQuestionList,List<AnswerQuestion> answerQuestionList){
        // 输出结果
