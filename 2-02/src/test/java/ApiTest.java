...
public class ApiTest {
    ...
    public void test_CacheService() throws Exception {
        ...
        CacheService proxy_EGM = MyProxy.getProxy(CacheServiceImpl.class, new EGMCacheAdapter());
        proxy_EGM.set("test-key", "cxy");
        String val01 = proxy_EGM.get("test-key");
        System.out.println("测试结果：" + val01);

        CacheService proxy_IIR = MyProxy.getProxy(CacheServiceImpl.class, new IIRCacheAdapter());
